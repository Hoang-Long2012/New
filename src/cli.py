...
def parseArgs():
	...
	Timestamp.add_argument("-a", "--access-time", type=float, metavar="ACCESS TIME", help="Update access time.")
	Timestamp.add_argument("-m", "--modified-time", type=float, metavar="MODIFIED TIME", help="Update modified time")
